...
var _CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  constructor(_viewContainerRef, _template, _differs, _viewRepeater, _viewport, ngZone) {
    ...
    this._viewport.renderedRangeStream.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((range2) => {
...
var _BreakpointObserver = class _BreakpointObserver {
  constructor(_mediaMatcher, _zone) {
    ...
    this._destroySubject = new import_rxjs4.Subject();
  }
  ...
  _observeElement(element) {
    return this._ngZone.runOutsideAngular(() => {
      if (!this._observedElements.has(element)) {
        const stream = new import_rxjs6.Subject();
...
var Typeahead = class {
  constructor(initialItems, config) {
    this._letterKeyStream = new import_rxjs7.Subject();
    this._items = [];
    this._selectedItemIndex = -1;
    this._pressedLetters = [];
    this._selectedItem = new import_rxjs7.Subject();
...
var TreeKeyManager = class {
  ...
  constructor(items, config) {
    ...
    this._items = [];
    this._typeaheadSubscription = import_rxjs7.Subscription.EMPTY;
    this._hasInitialFocused = false;
    this.change = new import_rxjs7.Subject();
...
var _InputModalityDetector = class _InputModalityDetector {
  ...
  constructor(_platform, ngZone, document2, options) {
    ...
    this._modality = new import_rxjs7.BehaviorSubject(null);
    this._lastTouchMs = 0;
    ...
    this.modalityDetected = this._modality.pipe((0, import_operators5.skip)(1));
    this.modalityChanged = this.modalityDetected.pipe((0, import_operators5.distinctUntilChanged)());
    if (_platform.isBrowser) {
      ngZone.runOutsideAngular(() => {
...
var _FocusMonitor = class _FocusMonitor {
  constructor(_ngZone, _platform, _inputModalityDetector, document2, options) {
    ...
    this._stopInputModalityDetector = new import_rxjs7.Subject();
  ...
  monitor(element, checkChildren = false) {
    ...
    const info = {
      checkChildren,
      subject: new import_rxjs7.Subject(),
      rootNode
    };
  ...
  _registerGlobalListeners(elementInfo) {
    ...
    if (++this._monitoredElementCount === 1) {
      ...
      this._inputModalityDetector.modalityDetected.pipe((0, import_operators5.takeUntil)(this._stopInputModalityDetector)).subscribe((modality) => {
        this._setOrigin(
          modality,
          true
          /* isFromInteraction */
...
var DateAdapter = class {
  constructor() {
    this._localeChanges = new import_rxjs8.Subject();
...
var _MatOption = class _MatOption {
  ...
  constructor(_element, _changeDetectorRef, _parent, group) {
    ...
    this._stateChanges = new import_rxjs8.Subject();
  }
  /**
...
//# sourceMappingURL=chunk-25CQWAQO.js.map
